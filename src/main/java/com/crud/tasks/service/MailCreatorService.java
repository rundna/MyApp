...
public class MailCreatorService {
    ...
    public String buildTrelloCardEmail(String message){
        ...
        context.setVariable("preview","Confirmation mail");
        context.setVariable("goodbye","Goodbye! "+adminConfig.getAdminName());
    ...
    public String sendTasksListEmail(String message){
